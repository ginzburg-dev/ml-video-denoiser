...
CHECKPOINT_TEMPORAL="${CHECKPOINT:-checkpoints/cs_test_linear_temporal/best.pth}"
...
OUTPUT_TEMPORAL_DIR="${OUTPUT_DIR:-checkpoints/cs_test_linear_temporal/infer_test}"
