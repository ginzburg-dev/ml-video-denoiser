#!/usr/bin/env bash
# train_cascade_mc_noise_dataset_tgb_safe_pod.sh — Three-stage NAFNetCascade training with calibrated MCNoise presets.
#
...
#
# Usage:
#   ./scripts/train_cascade_mc_noise_dataset_tgb_safe_pod.sh
#
# Override any variable on the command line, e.g.:
#   WORKERS=4 SIZE=small ./scripts/train_cascade_mc_noise_dataset_tgb_safe_pod.sh
#
# Skip individual stages:
#   SKIP_STAGE1=1 SPATIAL_WEIGHTS=/path/to/spatial/best.pth ./scripts/train_cascade_mc_noise_dataset_tgb_safe_pod.sh
#   SKIP_STAGE2=1 ./scripts/train_cascade_mc_noise_dataset_tgb_safe_pod.sh
#   SKIP_STAGE3=1 ./scripts/train_cascade_mc_noise_dataset_tgb_safe_pod.sh
...
NOISE_MC_CONFIG="${NOISE_MC_CONFIG:-$ROOT_DIR/nuke/mc_noise_presets_tgb_safe.json}"
...
EXP_NAME="${EXP_NAME:-mc_noise_dataset_tgb_safe}"
