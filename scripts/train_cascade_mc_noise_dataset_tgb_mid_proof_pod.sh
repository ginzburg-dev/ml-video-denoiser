#!/usr/bin/env bash
# train_cascade_mc_noise_dataset_tgb_mid_proof_pod.sh — Three-stage NAFNetCascade training with mid-focused MCNoise presets.
#
# Proof target:
#   Show that MCNoise can smooth the TGB *mid* sequences after Stage 1 spatial training.
...
NOISE_MC_CONFIG="${NOISE_MC_CONFIG:-$ROOT_DIR/nuke/mc_noise_presets_tgb_mid_proof.json}"
...
EXP_NAME="${EXP_NAME:-mc_noise_dataset_tgb_mid_proof}"
...
echo "========================================================"
echo "  NAFNetCascade — MCNoise MID proof training"
echo "  Size:             $SIZE"
