...
STAGE2_OUTPUT="${STAGE2_OUTPUT:-checkpoints/temporal_${SIZE}_stage2_v1}"
STAGE3_OUTPUT="${STAGE3_OUTPUT:-checkpoints/temporal_${SIZE}_stage3_v1}"
...
STAGE2_EPOCHS="${STAGE2_EPOCHS:-150}"  # more epochs needed at lower LR
STAGE3_EPOCHS="${STAGE3_EPOCHS:-120}"

SPATIAL_LR="${SPATIAL_LR:-1e-4}"
STAGE2_LR="${STAGE2_LR:-5e-5}"  # moderate — mixer is now ~7.5M params
                                # (temporal_mix 2×NAFBlock per level + bottleneck_mix)
