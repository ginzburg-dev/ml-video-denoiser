#!/usr/bin/env bash
# train_synthetic_noise_patches.sh — Three-stage NAFNetCascade training with real noise patches.
#
# Stage 1  Spatial      NAFNet spatial denoiser on clean sequences + patch pool noise
...
#   WORKERS=4 SIZE=small ./scripts/train_synthetic_noise_patches.sh
#
# Skip individual stages:
#   SKIP_STAGE1=1 SPATIAL_WEIGHTS=/path/to/spatial/best.pth ./scripts/train_synthetic_noise_patches.sh
#   SKIP_STAGE2=1 ./scripts/train_synthetic_noise_patches.sh
#   SKIP_STAGE3=1 ./scripts/train_synthetic_noise_patches.sh
