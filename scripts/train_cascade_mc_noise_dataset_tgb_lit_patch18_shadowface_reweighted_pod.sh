#!/usr/bin/env bash
# train_cascade_mc_noise_dataset_tgb_lit_patch18_shadowface_reweighted_pod.sh
# — Three-stage NAFNetCascade training with reweighted patch-balanced
# shadow+face MCNoise presets.
...
NOISE_MC_CONFIG="${NOISE_MC_CONFIG:-$ROOT_DIR/nuke/mc_noise_presets_tgb_lit_patch18_shadowface_reweighted.json}"

SIZE="${SIZE:-exp048}"
NUM_FRAMES="${NUM_FRAMES:-3}"
TEMPORAL_BASE="${TEMPORAL_BASE:-32}"
EXP_NAME="${EXP_NAME:-mc_noise_dataset_tgb_lit_patch18_shadowface_reweighted}"
...
echo "========================================================"
echo "  NAFNetCascade — MCNoise lit patch18 shadowface reweighted training"
echo "  Size:             $SIZE"
