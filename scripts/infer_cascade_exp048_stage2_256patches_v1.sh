...
CHECKPOINT="${CHECKPOINT:-checkpoints/cascade_exp048_stage2_256patches_v1/last.pth}"
...
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/cascade_exp048_stage2_256patches_v18/infer_test}"
